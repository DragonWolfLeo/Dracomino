...
@onready var ITEMS:Dictionary[int, ItemData] = [
	...
	# Traps Items (201-300)
	[201, "Tutorial",                 "tutorial",                   [ "trap", "useful", "on_lock", "tutorial" ] ],
	[202, "Logic Tutorial",           "tutorial_logic",             [ "trap", "useful", "on_lock", "tutorial" ] ],
...
var TRAP_LINK_MAPPINGS:Dictionary[StringName, Variant] = {
	...
	"Exposition Trap"         : "tutorial_logic", # "Random Cutscene",
	...
	"Literature Trap"         : "tutorial_logic", # "Random Cutscene",
	"Mana Drain Trap"         : "enchantment_curse",
	# "Market Crash Trap"       : "premium_trap",
	"Math Quiz Trap"          : "tutorial_logic",
	...
	"Pokemon Count Trap"      : "tutorial_logic",
	"Pokemon Trivia Trap"     : "tutorial_logic",
