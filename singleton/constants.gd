...
@onready var ITEMS:Dictionary[int, ItemData] = [
	...
	# Traps Items (201-300)
	[201, "Tutorial",                 "tutorial",                   [ "trap", "useful", "once", "on_lock" ] ],
	[202, "Logic Tutorial",           "logic_tutorial",             [ "trap", "useful", "once", "on_lock" ] ],
	...
	[210, "Well Done!",               "welldone",                   [ "trap", "on_lock", "rare" ] ],
	[211, "Crystal Trap",             "crystal_trap",               [ "trap", "on_spawn", "rare" ] ],
	[212, "Invert Colors Trap",       "invertcolors_trap",          [ "trap", "on_spawn", "rare" ] ],
	...
	[218, "Commitment Trap",          "commitment_trap",            [ "trap", "on_spawn", "rare" ] ],
...
var TRAP_ALIASES:Dictionary[StringName, String] = {
	...
	# enchantment_curse       = "Random Status Trap",
	# enchantment_legendary   = "Random Status Trap",
	# enchantment_epic        = "Random Status Trap",
	# enchantment_rare        = "Random Status Trap",
	# enchantment_mediumrare  = "Random Status Trap",
...
var TRAP_LINK_MAPPINGS:Dictionary[StringName, Variant] = {
	...
	# "Breakout Trap"           : "shatter_trap",
	"Bubble Trap"             : "water_trap",
	# "Bullet Time Trap"        : "Curse (Movement) Trap",
	# "Burn Trap"               : "fire_trap",
	# "Buyon Trap"              : "egg",
	# "Camera Rotate Trap"      : "Camera Rotate Trap",
	"Chaos Control Trap"      : "invertcolors_trap", #"Curse (Movement)+invertcolors_trap",
	# "Chart Modifier Trap"     : "Curse/Enchantment Trap",
	...
	# "Double Damage"           : "Curse (Gravity) Trap",
	# "Dry Trap"                : "Board Wipe Trap",
	# "Eject Ability"           : "impatience_trap",
	# "Electrocution Trap"      : "Legendary (Spin) Trap",
	# "Empty Item Box Trap"     : "Board Wipe Trap",
	# "Enemy Ball Trap"         : "egg",
	# "Energy Drain Trap"       : "Curse (Movement) Trap",
	# "Expensive Stocks"        : "premium_trap",
	"Exposition Trap"         : "logic_tutorial", # "Random Cutscene",
	# "Fake Transition"         : "Dummy Trap",
	# "Fast Trap"               : "Legendary (Movement) Trap",
	# "Fear Trap"               : "zoom_trap",
	# "fire_trap"               : "fire_trap",
	...
	# "Ice Trap"                : "Ice Trap",
	# "Icy Hot Pants Trap"      : "Legendary (Movement) Trap",
	...
	# "Iron Boots Trap"         : "Curse (Movement) Trap",
	...
	# "Meteor Trap"             : "Curse (Gravity) Trap",
	# "Mirror Trap"             : "Flip Trap",
	# "Monkey Mash Trap"        : "Reverse Controls+impatience_trap",
	# "My Turn! Trap"           : "impatience_trap",
	# "No Guarding"             : "Curse Trap",
	# "No Petals"               : "Curse Trap",
	# "No Revivals"             : "Curse Trap",
	# "No Stocks"               : "Curse Trap",
	# "No Vac Trap"             : "Disable Hold+Disable Rotate Trap",
	"Number Sequence Trap"    : "fishing",
	# "Nut Trap"                : "shatter_trap",
	"OmoTrap"                 : "tutorial",
	# "One Hit KO"              : "Curse (Gravity) Trap",
	# "Paper Trap"              : "I Trap",
	# "Paralyze Trap"           : "Curse (Movement) Trap",
	# "Paralysis Trap"          : "Curse (Movement) Trap",
	"Phone Trap"              : "tutorial",
	# "Pie Trap"                : "egg",
	# "Pinball Trap"            : "egg",
	"Pixelate Trap"           : "pixellation_trap",
	"Pixellation Trap"        : "pixellation_trap",
	# "Poison Mushroom"         : "Curse Trap",
	# "Poison Trap"             : "Curse Trap",
	...
	# "Stun Trap"               : "Curse (Movement) Trap",
	# "SvC Effect"              : "Curse/Enchantment Trap",
	# "Swap Trap"               : "Swap Trap",
	# "Tarr Trap"               : "glue_trap",
	# "Teleport Trap"           : "impatience_trap",
	"Text Trap"               : "tutorial", # "Random Cutscene",
	# "Thwimp Trap"             : "Curse (Gravity) Trap",
	# "Time Limit"              : "Curse (Cravity) Trap",
	# "Time Warp Trap"          : "Curse (Gravity) Trap",
	# "Timer Trap"              : "Curse (Gravity) Trap",
	# "Tiny Trap"               : "zoom_trap",
	"Tip Trap"                : "tutorial",
